...
def assign_countries(df):
    ...
    'United States': {'lat': (24, 49), 'lon': (-125, -66)},  # Contiguous + Alaska + Hawaii
    'Mexico': {'lat': (14, 33), 'lon': (-118, -86)},
    'Turkey': {'lat': (35, 43), 'lon': (25, 45)},
    'Iran': {'lat': (24, 41), 'lon': (44, 64)},
    'Peru': {'lat': (-18, 0), 'lon': (-82, -68)},
    'Greece': {'lat': (34, 43), 'lon': (19, 30)},
    'Italy': {'lat': (36, 47), 'lon': (6, 19)},
    'Philippines': {'lat': (4, 22), 'lon': (116, 127)},
    'New Zealand': {'lat': (-48, -34), 'lon': (166, 179)},
    'China': {'lat': (18, 54), 'lon': (73, 135)},
    'India': {'lat': (6, 38), 'lon': (68, 98)},
    'Afghanistan': {'lat': (29, 39), 'lon': (60, 75)},
    'Russia': {'lat': (41, 82), 'lon': (-170, 180)},  # Include far east & far west (crosses date line)
    ...
    'Algeria': {'lat': (19, 38), 'lon': (-9, 12)},
    'Ethiopia': {'lat': (3, 15), 'lon': (33, 48)},
    'Kenya': {'lat': (-5, 5), 'lon': (34, 42)},
    'Tanzania': {'lat': (-12, -1), 'lon': (29, 41)},
    'Madagascar': {'lat': (-26, -11), 'lon': (43, 51)},
    'Canada': {'lat': (42, 83), 'lon': (-141, -52)},
    'Brazil': {'lat': (-34, 5), 'lon': (-74, -34)},
    'Argentina': {'lat': (-56, -21), 'lon': (-74, -53)},
    'Colombia': {'lat': (-5, 13), 'lon': (-79, -66)},
    'Saudi Arabia': {'lat': (16, 32), 'lon': (34, 56)},
    'South Korea': {'lat': (33, 39), 'lon': (124, 130)},
    'North Korea': {'lat': (37, 43), 'lon': (124, 131)},
    'Bangladesh': {'lat': (20, 27), 'lon': (88, 92)},
    'Vietnam': {'lat': (8, 24), 'lon': (102, 110)},
    'Pakistan': {'lat': (23, 37), 'lon': (60, 77)},
    'Nepal': {'lat': (26, 31), 'lon': (80, 89)},
    'Sweden': {'lat': (55, 69), 'lon': (11, 24)},
    'Norway': {'lat': (57, 71), 'lon': (4, 32)},
    'Finland': {'lat': (59, 70), 'lon': (20, 32)},
